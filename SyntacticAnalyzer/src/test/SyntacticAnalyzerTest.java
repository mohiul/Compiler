...
public class SyntacticAnalyzerTest {
	...
	public void testProgErr1() throws IOException{
		parser.setLexReader("program id { };");
		assertTrue(parser.parse());
	...
	public void testClassDecl() throws IOException{
		parser.setLexReader("class test { }; program { };");
		assertTrue(parser.parse());
	...
	public void testClassDeclErr1() throws IOException{
		parser.setLexReader("class test id { }; program { };");
		assertFalse(parser.parse());
	...
	public void testClassDecls() throws IOException{
		parser.setLexReader("class test { }; class test1 { }; program { };");
		assertTrue(parser.parse());
	...
	public void testClassIdDecl() throws IOException{
		parser.setLexReader("class test { int id; }; program { };");
		assertTrue(parser.parse());
	...
	public void testClassIdFuncDecls() throws IOException{
		parser.setLexReader("class test { int id; float func(){}; }; program { };");
		assertTrue(parser.parse());
	...
	public void testClassIdDecls() throws IOException{
		parser.setLexReader("class test { int id; float id2; }; program { };");
		assertTrue(parser.parse());
	...
	public void testMultiArrays() throws IOException{
		parser.setLexReader("class test { int var1[4][5][7][8][9][1][0]; float id2[11][12]; }; program { };");
		assertTrue(parser.parse());
	...
	public void testClassIdDeclFuncDecl() throws IOException{
		parser.setLexReader("class test { int id; float func(int array[100]){}; }; program { };");
		assertTrue(parser.parse());
	...
	public void testClassIdDeclFuncDecls() throws IOException{
		parser.setLexReader("class test { int id; float func(int array[100]){}; float func1(test testId){}; }; program { };");
		assertTrue(parser.parse());
	...
	public void testFunctionWithReturn() throws IOException{
		parser.setLexReader("program { int id; }; float func(int array[100]){ int minValue; return (minValue); };");
		assertTrue(parser.parse());
	}
	...
	public void testIdExpressions() throws IOException{
		parser.setLexReader("program { int id; id = 1 + 2; };");
		assertTrue(parser.parse());
	...
	public void testIdNest() throws IOException{
		parser.setLexReader("program { arrayUtility[1][1][1][1].var1[4][1][0][0][0][0][0] = 2; };");
		assertTrue(parser.parse());
	...
	public void testIdNestErr1() throws IOException{
		parser.setLexReader("program { arrayUtility[1][1][1][1]..var1[4][1] = 2; };");
		assertFalse(parser.parse());
	...
	public void testIF() throws IOException{
		parser.setLexReader("program { if(array[idx] > maxValue) then { maxValue = array[idx]; } else{}; };");
		assertTrue(parser.parse());
	...
	public void testForIF() throws IOException{
		parser.setLexReader("program { for( int idx = 1; idx <= 99; idx = ( idx ) + 1){if(array[idx] < maxValue) then {maxValue = array[idx];}else{};}; };");
		assertTrue(parser.parse());
	...
	public void testGetPut() throws IOException{
		parser.setLexReader("program { get(sample[t]); put(maxValue); };");
		assertTrue(parser.parse());
	...
	public void testExpressions() throws IOException{
		parser.setLexReader("program { float value; value = 100 * (2 + 3.0 / 7.0006); value = 1.05 + ((2.04 * 2.47) - 3.0) + 7.0006 ; return (value); };");
		assertTrue(parser.parse());
